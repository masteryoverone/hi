...
local astKindExpressionLookup = {
	...
	[AstKind.BitwiseOrExpression] = 9.8;
	[AstKind.BitwiseXorExpression] = 9.6;
	[AstKind.BitwiseAndExpression] = 9.4;
	[AstKind.ShiftLeftExpression] = 9.2;
	[AstKind.ShiftRightExpression] = 9.2;
...
function Ast.ShiftLeftExpression(lhs, rhs, simplify)
	return {
		kind = AstKind.ShiftLeftExpression,
		lhs = lhs,
		rhs = rhs,
		isConstant = false,
	}
end
function Ast.ShiftRightExpression(lhs, rhs, simplify)
	return {
		kind = AstKind.ShiftRightExpression,
		lhs = lhs,
		rhs = rhs,
		isConstant = false,
	}
